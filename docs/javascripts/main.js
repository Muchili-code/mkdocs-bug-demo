...
(function ($) {
	...
	class Silence {
		...
		buildCustomElements() {
			...
			$("#navList").append('<li><a id="blog_nav_myyoulian" class="menu" href="https://www.cnblogs.com/Muchilli">友链</a><i></i></li><li><a id="blog_nav_myzanshang" class="menu" href="https://www.cnblogs.com/Muchilli">赞赏</a><i></i></li><li><a id="blog_nav_myguanyu" class="menu" href="">关于</a><i></i></li>');
			//添加标签icon
		...
		buildBloggerProfile() {
			...
			var title = '<div class="site-branding">' +
					...
					'<a href="https://www.cnblogs.com/Muchilli" alt="Muchilli">' +
					'<ruby><span class="sakuraso">Muchilli</span><span class="no">の</span><span class="shironeko">Blog</span>' +
					'<rt class="chinese-font">慕迟离</rt></ruby></a></span>' +
					'</div>'
			$('body').prepend(title);
